...
# Variable global para el archivo de entrada
ARCHIVO_EXCEL = "modulos/UsuariosParaProcesar.xlsx"

def convertir_excel_a_txt(archivo_salida=None, moneda="USD"):
    """
...
def generar_txt_dolares(archivo_salida=None):
    """Genera archivo TXT con moneda en dólares (USD)"""
    return convertir_excel_a_txt(archivo_salida, moneda="USD")

# Función para generar TXT en soles
def generar_txt_soles(archivo_salida=None):
    """Genera archivo TXT con moneda en soles (PEN)"""
    return convertir_excel_a_txt(archivo_salida, moneda="PEN")
...
if not os.path.exists(ARCHIVO_EXCEL):
    ...
    print("- generar_txt_dolares()")
    print("- generar_txt_soles()")

# Ejemplos de uso:
# generar_txt_dolares()
# generar_txt_soles()
generar_txt_dolares("archivo_personalizado_dolares.txt")
generar_txt_soles("archivo_personalizado_soles.txt")